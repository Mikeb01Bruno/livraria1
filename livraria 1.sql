...
INSERT INTO Livraria.autores(Livro, Autor, Sexo_Autor, Num_Pag, Editora, Valor_Capa_Comum, Valor_Kindle, Ano_de_Publicacao)
...
delete FROM Livraria.autores WHERE id=1;

-- Update Tabela

UPDATE Livraria.autores SET Autor = 'Joselíno' where id= 2;
...
SELECT id, Autor, editora,  Ano_de_Publicacao from livraria.autores 
...
SELECT id, sexo_autor, livro, editora from livraria.autores
...
select id, Livro, Editora, Autor, Editora FROM Livraria.autores
